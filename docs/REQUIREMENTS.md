...
| SKILL-001 | Provider-neutral evidence and research skills install through the approved bootstrap plan | 0/4 | five Apache-2.0 SKILL.md packages, package and CLI E2E | done |
