...
| ENGINE-004 | The built-in ManagedRunner owns structured execution, workspace boundary, approval pause/resume, and retries | 4 | structured artifact, repair/cancel tests; general tool loop pending | partial |
